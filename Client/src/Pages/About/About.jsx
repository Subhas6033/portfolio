...
import { GraduationCap, Eye, MapPin, Calendar, Code, Globe, Award } from 'lucide-react'
...
const educationData = [
  {
    ...
    period: "2023 - 2027",
    description: "Pursuing B.Tech in Information Technology department. Secured 7.2 DGPA with focus on software development and web technologies.",
  ...
  },
  {
    ...
    period: "2020 - 2022",
    description: "Science stream with Physics, Chemistry, Mathematics, and Biology. Secured 372 out of 500 marks, affiliated with WBCHSE.",
  ...
  },
  {
    ...
    period: "2015 - 2020",
    description: "Secured 647 out of 700 marks, affiliated with West Bengal Council of Higher Secondary Education.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="anim-fadeUp mb-16">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-lime-400 text-xs font-bold uppercase tracking-widest">About Me</span>
            </div>
            ...
            <div className="order-2 space-y-6">
              <SlideLeftAnimation>
                <p className="text-lg md:text-xl text-zinc-300 leading-relaxed">
                  Hello! <span className="text-lime-400">I'm Subhas Mondal</span>, from
                  Kotulpur, West Bengal. I am a pre-final-year student pursuing
                  <span className="text-lime-400"> B.Tech in Information Technology</span> from
              ...
              <SlideLeftAnimation>
                <p className="text-zinc-400 leading-relaxed">
                  I am proficient in <span className="text-white font-semibold">data structures</span> and
                  <span className="text-white font-semibold"> algorithms</span>, and programming languages like
                  <span className="text-white font-semibold"> C++</span>,{' '}
                  <span className="text-white font-semibold">Java</span>, and{' '}
                  <span className="text-white font-semibold">Python</span>. I'm also a{' '}
                  <span className="text-lime-400 font-semibold">Full Stack Developer</span> specializing in
                  MERN & Next.js and <span className="text-white font-semibold">React Native</span> development.
                </p>
              </SlideLeftAnimation>

              <SlideLeftAnimation>
                <p className="text-zinc-400 leading-relaxed">
                  I'm enthusiastic about software development and currently looking for an{' '}
                  <span className="text-lime-400 font-semibold">internship</span> or{' '}
                  <span className="text-lime-400 font-semibold">full-time opportunity</span>.
                </p>
              </SlideLeftAnimation>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button
                  onClick={() => window.open("https://drive.google.com/file/d/1Du7IFCujKnLB4m3vwFuowdjJYCsFQIgg/view?usp=sharing")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            <SlideUpAnimation>
              <div className="p-6 rounded-2xl bg-zinc-900/80 border border-zinc-800/60">
                <div className="flex items-center gap-3 mb-4">
