...
const CONTACT_INFO = [
  {
    icon: "📧",
    label: "Email",
    val: "goalkeepersubhas07@gmail.com",
    href: "mailto:goalkeepersubhas07@gmail.com",
  },
  {
    icon: "📞",
    label: "Phone",
    val: "+91 9832395096",
    href: "tel:+919832395096",
  },
  {
    icon: "🌐",
    label: "Website",
    val: "subhas.vercel.app",
    href: "https://subhas.vercel.app",
  },
  {
    icon: "📍",
    label: "Location",
    val: "Balitha, West Bengal, India",
    href: null,
  },
];
...
export default function Contact() {
  ...
  // Dynamically load the reCAPTCHA v2 script once
  useEffect(() => {
  ...
  const onSubmit = async (data) => {
    ...
    // Guard: user hasn't ticked the box yet
    ...
    // Only start loading AFTER all early-return guards
    setLoading(true);
    setStatus(null);
    ...
    try {
      ...
      if (statusCode === 422) {
        setErrorMessage(
          "Please use a valid email address, not a disposable one.",
        );
      } else if (statusCode === 400) {
        setErrorMessage(
          backendMessage || "Please enter a valid email address.",
        );
      } else {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-zinc-950 pt-28 pb-24 px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 items-start">
            ...
            <div className="anim-fadeUp">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                {/* reCAPTCHA v2 widget — rendered by the loaded script */}
                  ...
                  <div key={c.label} className="flex items-center gap-4 group">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {c.href ? (
                        <a
                          href={c.href}
                          className="text-white text-sm font-medium truncate block hover:text-lime-400 transition-colors duration-200"
                        >
                          {c.val}
                        </a>
                      ) : (
        ...
        {status && (
          <div
            className={`fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 px-5 py-3 rounded-2xl border backdrop-blur-md shadow-2xl transition-all duration-300 anim-fadeUp ${
              status === "success"
