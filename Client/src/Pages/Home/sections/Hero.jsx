...
function StatsRow({ months }) {
  ...
  const displayMonths = useCounter(5, inView);
    ...
    <div ref={ref} className="flex items-center gap-10">
      {[
        ...
        <div key={s.label}>
          ...
          <div className="text-zinc-600 text-xs mt-0.5 uppercase tracking-widest">
            {s.label}
          </div>
        </div>
      ))}
...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-zinc-950 overflow-hidden pt-20"
    >
      {/* Grid overlay */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 w-full py-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-center">
          ...
          <div>
            ...
            {/* Typewriter role */}
            <div
              className="anim-fadeUp d-3 flex items-center gap-3 mb-8"
              style={{ height: "36px" }}
            >
              ...
              <span
                className="inline-block w-0.5 h-5 bg-lime-400"
            ...
            <div className="anim-fadeUp d-4">
              <p className="text-zinc-500 text-base leading-relaxed max-w-lg mb-10">
                ...
                Clean code, sharp UIs, and a passion for great developer
                experience.
              </p>
            </div>
            ...
            <div className="anim-fadeUp d-5 flex items-center gap-4 mb-12">
              ...
              <ArrowBtn outline onClick={() => navigate("/projects")}>
                View My Work
              </ArrowBtn>
            </div>
          ...
          <div className="anim-fadeRight d-3 relative hidden lg:flex justify-end">
            <div className="relative">
              ...
              <div
                ...
                style={{
                  boxShadow:
                    "0 0 60px rgba(163,230,53,0.15), inset 0 0 60px rgba(163,230,53,0.03)",
                }}
              />
              ...
              <div className="w-72 aspect-[3/4] rounded-2xl overflow-hidden border border-zinc-700/60 relative bg-zinc-900">
                <img
                  src={profileImage || "/Image/My Picture3.jpg"}
                  alt="Subhas Mondal"
