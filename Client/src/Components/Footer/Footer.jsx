...
function Footer() {
  ...
  const socials = [
    ...
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/subhas6033/",
      Icon: LinkedinIcon,
    },
    {
      label: "Twitter",
      href: "https://x.com/SubhasM25064046",
      Icon: TwitterIcon,
    },
    {
      label: "Email",
  ...
  return (
    <footer className="bg-zinc-950 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(163,230,53,0.04) 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-14">
          <div>
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 bg-lime-400 rounded-lg flex items-center justify-center shadow-[0_0_20px_rgba(163,230,53,0.3)]">
                <span className="text-zinc-950 font-black text-base leading-none">
                  S
                </span>
              </div>
              <div>
            ...
            <p className="text-zinc-600 text-sm leading-relaxed mb-6">
              ...
              clean code, sharp UIs, real impact.
            </p>
          ...
          <div>
            <h4 className="text-zinc-400 text-xs font-bold uppercase tracking-widest mb-5">
              Services
            </h4>
              ...
              {[
                ...
                <li key={c.val}>
                  {c.href ? (
                    <a
                      href={c.href}
                      className="flex items-center gap-2.5 text-zinc-600 hover:text-lime-400 text-sm transition-colors duration-200"
                    >
        ...
        <div className="border-t border-zinc-800/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-zinc-700 text-xs">
            © {new Date().getFullYear()} Subhas Mondal. All rights reserved.
          </p>
